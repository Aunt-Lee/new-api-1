  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        <Modal
          title='Confirm configuration migration'
          ...
          cancelText='Cancel'
        >
          <p>Configuration data from an older version was found. Migrate it to the new format?</p>
          <p style={{ color: '#f57c00', marginTop: '10px' }}>
            <strong>Note:</strong>
            The data format will be converted automatically, and the legacy configuration will be removed after migration. Back up the legacy configuration in the database first.
          </p>
        </Modal>
