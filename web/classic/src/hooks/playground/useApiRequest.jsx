      ...
      try {
        ...
        if (!response.ok) {
          ...
          try {
            ...
            if (!errorBody) {
              errorBody = 'Unable to read the error response body';
            }
          }
    ...
    (payload) => {
      ...
      source.addEventListener('message', (e) => {
        ...
        try {
          ...
          const errorInfo = `Parse error: ${error.message}`;
      ...
      source.addEventListener('readystatechange', (e) => {
        ...
        if (
          ...
          const errorInfo = handleApiError(new Error('HTTP status error'));
      ...
      try {
        ...
        setDebugData((prev) => ({
          ...prev,
          response: 'Failed to start stream:\n' + JSON.stringify(errorInfo, null, 2),
        }));
        setActiveDebugTab(DEBUG_TABS.RESPONSE);
