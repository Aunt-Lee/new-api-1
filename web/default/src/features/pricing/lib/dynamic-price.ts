...
*/
import { formatModelPricingBillingCurrencyFromUSD } from '@/features/pricing/lib/display-currency'
...
export function formatDynamicUnitPrice(
  ...
  return formatModelPricingBillingCurrencyFromUSD(displayPrice, {
    digitsLarge: 4,
    digitsSmall: 6,
    abbreviate: false,
  })
