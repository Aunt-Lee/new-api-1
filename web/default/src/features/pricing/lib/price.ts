...
*/
import { formatModelPricingCurrencyFromUSD } from '@/features/pricing/lib/display-currency'
 ...
 *
 * The returned value will be formatted by formatModelPricingCurrencyFromUSD, which will
 ...
 *    - usdExchangeRate = 1
 *    - Return: 1 × 0.5 / 1 = 0.5
 *    - formatModelPricingCurrencyFromUSD(0.5) → $0.5 ✓
 *
 ...
 *    - Return: 1 × 4 / 7 = 0.571
 *    - formatModelPricingCurrencyFromUSD(0.571) → 0.571 × 7 = ¥4 ✓
...
export function formatPrice(
  ...
  return formatModelPricingCurrencyFromUSD(price, {
    digitsLarge: 4,
    digitsSmall: 6,
    abbreviate: false,
  })
...
export function formatFixedPrice(
  ...
  return formatModelPricingCurrencyFromUSD(priceInUSD, {
    digitsLarge: 4,
    digitsSmall: 4,
    abbreviate: false,
  })
